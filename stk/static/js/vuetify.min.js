...
const{transition:n,disabled:o,group:r,target:i,...s}=e,{component:u=(r?t.TransitionGroup:t.Transition),...c}=V(n)?n:{}
let d
return d=V(n)?t.mergeProps(c,function(e){const t=["checked","disabled"]
...
const{backgroundColorClasses:o,backgroundColorStyles:i}=vl(()=>e.color),{roundedClasses:s}=fl(e),u=mt("VImg"),c=t.shallowRef(""),d=t.ref(),v=t.shallowRef(e.eager?"loading":"idle"),p=t.shallowRef(),m=t.shallowRef()
let f=!1
...
const a=t.createElementVNode("img",{class:t.normalizeClass(["v-img__img",N.value,e.imageClass]),style:{objectPosition:e.position},crossorigin:e.crossorigin,src:g.value.src,srcset:g.value.srcset,alt:e.alt,referrerpolicy:e.referrerpolicy,draggable:e.draggable,sizes:e.sizes,ref:d,onLoad:V,onError:w},null),l=n.sources?.()
return t.createVNode(hl,{transition:e.transition,appear:!0},{default:()=>[t.withDirectives(l?t.createElementVNode("picture",{class:"v-img__picture"},[l,a]):a,[[t.vShow,"loaded"===v.value]])]})},E=()=>t.createVNode(hl,{transition:e.transition},{default:()=>[g.value.lazySrc&&"loaded"!==v.value&&t.createElementVNode("img",{class:t.normalizeClass(["v-img__img","v-img__img--preload",N.value]),style:{objectPosition:e.position},crossorigin:e.crossorigin,src:g.value.lazySrc,alt:e.alt,referrerpolicy:e.referrerpolicy,draggable:e.draggable},null)]}),I=()=>n.placeholder?t.createVNode(hl,{transition:e.transition,appear:!0},{default:()=>[("loading"===v.value||"error"===v.value&&!n.error)&&t.createElementVNode("div",{class:"v-img__placeholder"},[n.placeholder()])]}):null,_=()=>n.error?t.createVNode(hl,{transition:e.transition,appear:!0},{default:()=>["error"===v.value&&t.createElementVNode("div",{class:"v-img__error"},[n.error()])]}):null,P=()=>e.gradient?t.createElementVNode("div",{class:"v-img__gradient",style:{backgroundImage:`linear-gradient(${e.gradient})`}},null):null,A=t.shallowRef(!1)
{const e=t.watch(h,t=>{t&&(requestAnimationFrame(()=>{requestAnimationFrame(()=>{A.value=!0})}),e())})}return Bt(()=>{const a=ul.filterProps(e)
return t.withDirectives(t.createVNode(ul,t.mergeProps({class:["v-img",{"v-img--absolute":e.absolute,"v-img--booting":!A.value,"v-img--fit-content":"fit-content"===e.width},o.value,s.value,e.class],style:[{width:b("auto"===e.width?p.value:e.width)},i.value,e.style]},a,{aspectRatio:h.value,"aria-label":e.alt,role:e.alt?"img":void 0}),{additional:()=>t.createElementVNode(t.Fragment,null,[t.createVNode(C,null,null),t.createVNode(E,null,null),t.createVNode(P,null,null),t.createVNode(I,null,null),t.createVNode(_,null,null)]),default:n.default}),[[Vl,{handler:y,options:e.options},null,{once:!0}]])}),{currentSrc:c,image:d,state:v,naturalWidth:p,naturalHeight:m}}}),Sl=vt({border:[Boolean,Number,String]},"border")
...
V.value=Math.max(V.value,performance.now()-e),T()},V),x=t.watch(g,e=>{e&&(x(),v=d.value.offsetTop,S.immediate(),T(),~w&&t.nextTick(()=>{o&&window.requestAnimationFrame(()=>{F(w),w=-1})}))})
...
Math.max(e,t)>100?(r.value=l,i.value=o):(l<=0&&(r.value=l),o>=a.value.length&&(i.value=o,r.value=l))}s.value=N(r.value),u.value=N(a.value.length)-N(i.value)}function F(e){const t=N(e)
...
let N,C="",E=0,I=!1
const _=t.computed(()=>{const t=m.value?f.value:d.value
return e.hideSelected?t.filter(t=>!h.value.some(a=>(e.valueComparator||St)(a,t))):t}),P=t.computed(()=>e.hideNoData&&!_.value.length||b.isReadonly.value||b.isDisabled.value),A=la(e,"menu"),R=t.computed({get:()=>A.value,set:e=>{A.value&&!e&&i.value?.ΨopenChildren.size||e&&P.value||(A.value=e)}}),{menuId:T,ariaExpanded:D,ariaControls:$}=cs(0,R),F=t.computed(()=>({...e.menuProps,activatorProps:{...e.menuProps?.activatorProps||{},"aria-haspopup":"listbox"}})),M=t.ref(),z=as(M,r),L=ts(R,()=>i.value?.contentEl,()=>r.value?.controlRef),{onTabKeydown:O}=ls({groups:[{type:"element",contentRef:s},{type:"list",contentRef:M,displayItemsCount:()=>_.value.length},{type:"element",contentRef:u}],onLeave:()=>{R.value=!1,r.value?.focus()}})
function j(t){e.openOnClear&&(R.value=!0)}function H(){P.value||(I=!1,R.value=!R.value)}function W(e){"Tab"===e.key&&O(e),M.value?.$el.contains(e.target)&&ue(e)&&Y(e)}function Y(t){if(!t.key||b.isReadonly.value)return
if(["Enter"," ","ArrowDown","ArrowUp","Home","End"].includes(t.key)&&t.preventDefault(),["Enter","ArrowDown"," "].includes(t.key)&&(I=!0,R.value=!0),["Escape","Tab"].includes(t.key)&&(R.value=!1),e.clearable&&"Backspace"===t.key)return t.preventDefault(),h.value=[],void j()
...
if(!o)return
const[r,i]=o
E=i,M.value?.focus(i),e.multiple||(h.value=[r])}function U(a){let l=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
...
h.value=e?[a]:[],t.nextTick(()=>{R.value=!1})}}function G(e){const t=e.target
r.value?.$el.contains(t)||(R.value=!1)}function K(){if(e.eager&&c.value?.calculateVisibleItems(),M.value&&k.value){const t=function(){if(!h.value.length)return-1
const t=e.valueComparator||St
let a=0
for(const e of _.value){if(h.value.some(a=>t(a.value,e.value)))return e.props.disabled?-1:a
e.props.disabled||a++}return-1}()
t>=0?M.value.focus(t,{focusVisible:!1,preventScroll:e.noAutoScroll}):I&&M.value.focus("first",{focusVisible:!1,preventScroll:e.noAutoScroll})}}function q(){m.value="",k.value&&(i.value?.contentEl?._clickOutside?.lastMousedownWasOutside?k.value=!1:r.value?.focus())}function X(e){k.value=!0}function Z(e){if(!r.value?.$el.contains(e.relatedTarget)){if(L(e))return
k.value=!1}}function Q(e){if(null==e)h.value=[]
else if(oe(r.value,":autofill")||oe(r.value,":-webkit-autofill")){const t=d.value.find(t=>t.title===e)
t&&U(t)}else r.value&&(r.value.value="")}return t.watch(R,t=>{if(t||(I=!1),!e.hideSelected&&R.value&&h.value.length){const t=_.value.findIndex(t=>h.value.some(a=>(e.valueComparator||St)(a.value,t.value)))
o&&!e.noAutoScroll&&window.requestAnimationFrame(()=>{t>=0&&c.value?.scrollToIndex(t)})}}),t.watch(d,(t,a)=>{R.value||k.value&&e.hideNoData&&!a.length&&t.length&&(R.value=!0)}),Bt(()=>{const a=!(!e.chips&&!l.chip),o=!!(!e.hideNoData||_.value.length||l["prepend-item"]||l["append-item"]||l["no-data"]),v=h.value.length>0,p=Ki.filterProps(e),b=v||!k.value&&e.label&&!e.persistentPlaceholder?void 0:e.placeholder,N={search:m,filteredItems:f.value}
return t.createVNode(Ki,t.mergeProps({ref:r},p,{modelValue:h.value.map(e=>e.props.title).join(", "),name:void 0,"onUpdate:modelValue":Q,focused:k.value,"onUpdate:focused":e=>k.value=e,validationValue:h.externalValue,counterValue:y.value,dirty:v,class:["v-select",{"v-select--active-menu":R.value,"v-select--chips":!!e.chips,["v-select--"+(e.multiple?"multiple":"single")]:!0,"v-select--selected":h.value.length,"v-select--selection-slot":!!l.selection},e.class],style:e.style,inputmode:"none",placeholder:b,"onClick:clear":j,"onMousedown:control":H,onBlur:G,onKeydown:Y,"aria-expanded":D.value,"aria-controls":$.value}),{...l,default:r=>{let{id:v}=r
return t.createElementVNode(t.Fragment,null,[t.createElementVNode("select",{hidden:!0,multiple:e.multiple,name:V.fieldName.value},[d.value.map(e=>t.createElementVNode("option",{key:e.value,value:e.value,selected:w.value.includes(e.value)},null))]),t.createVNode(Ti,t.mergeProps({id:T.value,ref:i,modelValue:R.value,"onUpdate:modelValue":e=>R.value=e,activator:"parent",captureFocus:!1,disabled:P.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:K,onAfterLeave:q},F.value,{contentClass:["v-select__content",F.value.contentClass]}),{default:()=>[t.createVNode(Di,{onFocusin:X,onFocusout:Z,onKeydown:W},{default:()=>[l["menu-header"]&&t.createElementVNode("header",{ref:s},[l["menu-header"](N)]),o&&t.createVNode(Or,t.mergeProps({key:"select-list",ref:M,selected:w.value,selectStrategy:e.multiple?"independent":"single-independent",tabindex:"-1",selectable:!!_.value.length,"aria-live":"polite","aria-labelledby":`${v.value}-label`,"aria-multiselectable":e.multiple,color:e.itemColor??e.color},z,e.listProps),{default:()=>[l["prepend-item"]?.(),!_.value.length&&!e.hideNoData&&(l["no-data"]?.()??t.createVNode(Cr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(es,{ref:c,renderless:!0,items:_.value,itemKey:"value"},{default:a=>{let{item:n,index:o,itemRef:r}=a
const i=function(e){const a={}
for(const l in e)a[t.camelize(l)]=e[l]
return a}(n.props),s=t.mergeProps(n.props,{ref:r,key:n.value,onClick:()=>U(n,null),"aria-posinset":o+1,"aria-setsize":_.value.length})
...
return $(r.value,0,e)}),d=t.computed(()=>c.value*i.value),v=t.computed(()=>pu(a.parsedStart.value,a.parsedEnd.value,a.times.today,a.weekdaySkips.value,e.maxDays)),p=t.computed(()=>{const e=v.value,t=u.value,l=o.value,n=c.value,r=a.times.now
return e.map(e=>function(e,t,a,l,n){const o=[]
for(let r=0;r<l;r++){const l=t+r*a,i=nu(e)
o.push(eu(i,l,n))}return o}(e,t,l,n,r))}),m=t.computed(()=>e.intervalFormat?e.intervalFormat:mu(a.locale.current.value,(e,t)=>t?0===e.minute?{timeZone:"UTC",hour:"numeric"}:{timeZone:"UTC",hour:"numeric",minute:"2-digit"}:{timeZone:"UTC",hour:"2-digit",minute:"2-digit"}))
...
return!1===l||(l*=d.value,a?l<0?l=0:l>d.value&&(l=d.value):l<0?l+=d.value:l>d.value&&(l-=d.value)),l}function h(e,t){let a=Ws(e)
if(!1===a)return!1
const l=c.value*o.value
if(t&&"object"==typeof e&&"day"in e){a+=(Ks(e)-Ks(t))*l}return(a-u.value)/l}return{...a,scrollAreaRef:l,parsedFirstInterval:n,parsedIntervalMinutes:o,parsedIntervalCount:r,parsedIntervalHeight:i,parsedFirstTime:s,firstMinute:u,bodyHeight:d,days:v,intervals:p,intervalFormatter:m,showIntervalLabelDefault:function(e){const t=p.value[0][0]
...
return!(!1===t||!a)&&(a.scrollTop=t,!0)},minutesToPixels:f,timeToY:g,timeDelta:h}}const Ou={mounted:function(e,t){const a=t.value,l={passive:!t.modifiers?.active}
...
if(a&&e in a)return a[e]}Gg.version="3.12.11"
const qg=function(){return Gg({components:Mg,directives:Yg,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},Xg="3.12.11"
