...
stk now leverages Cursor Rules for intelligent code assistance and generation. This approach provides:

- Context-aware code generation through modern AI-powered IDEs
- Codebase-specific guidance tailored to stk's patterns
...
The source code is available on [GitHub](https://github.com/level09/stk).

## Contributing

We welcome contributions! Please read our [Contributing Guide](https://github.com/level09/stk/blob/master/CONTRIBUTING.md) for details. 