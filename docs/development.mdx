...
uv run quart verify --json            # Lint, sanity, and migration checks
uv run quart smoke --json             # Real-browser smoke check (Playwright)
uv run quart report                   # Static project review artifact
uv run quart new <module>             # Deterministic module scaffold
```
