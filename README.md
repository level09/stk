...
**[Live Demo](https://demo.stk.dev/)** · **[Tutorials](https://github.com/level09/stk/wiki)** · **[Docs](https://docs.stk.dev)** · **Stop configuring. Start shipping.**
...
> **Want payments?** → **[ReadyKit](https://readykit.dev)** adds Stripe, multi-tenancy, teams on top of stk
...
- **Ember color palette** - Fire-inspired theme matching the stk brand
...
Documentation: [docs.stk.dev](https://docs.stk.dev)
